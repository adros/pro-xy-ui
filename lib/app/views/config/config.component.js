...
let ConfigComponent = class ConfigComponent {
    constructor(dialog, socketService, cd, snackBar) {
        this.dialog = dialog;
...
ConfigComponent = __decorate([
    ...
    __metadata("design:paramtypes", [material_1.MdDialog, socket_service_1.SocketService, core_1.ChangeDetectorRef, material_2.MdSnackBar])
], ConfigComponent);
