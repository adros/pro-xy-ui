...
let RequestsComponent = class RequestsComponent {
    constructor(zone, trafficService, cd, dragulaService) {
        this.zone = zone;
...
RequestsComponent = __decorate([
    ...
    __metadata("design:paramtypes", [core_1.NgZone, traffic_service_1.TrafficService, core_1.ChangeDetectorRef, ng2_dragula_1.DragulaService])
], RequestsComponent);
