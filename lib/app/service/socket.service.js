...
var SocketService = (function () {
    function SocketService(zone, configService /*, private app: ApplicationRef*/) {
        this.zone = zone;
        this.configService = configService; /*, private app: ApplicationRef*/
        ...
        this._requestsSubject = Observable_1.Observable.fromEvent(socket, "request")
            .publishReplay(100);
        this._requestsSubject.connect();
    }
...
SocketService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [core_1.NgZone, config_service_1.ConfigService /*, private app: ApplicationRef*/])
], SocketService);
