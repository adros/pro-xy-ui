...
var SocketService = (function () {
    function SocketService(zone, configService, app) {
        this.zone = zone;
    ...
    SocketService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [core_1.NgZone, config_service_1.ConfigService, core_1.ApplicationRef])
    ], SocketService);
