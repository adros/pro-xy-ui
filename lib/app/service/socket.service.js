...
var SocketService = (function () {
    function SocketService(configService, zone) {
        var _this = this;
    ...
    SocketService.prototype.registerShortcut = function () {
        var _this = this;
        var shortcut = new nw.Shortcut({
            key: "Ctrl+R",
            active: function () { return _this.zone.run(function () { return _this.connectToRemote(); }); }
        });
        nw.App.registerGlobalHotKey(shortcut);
    };
    SocketService.prototype.connectToRemote = function () {
