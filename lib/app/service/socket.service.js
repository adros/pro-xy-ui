...
let SocketService = class SocketService {
    constructor(configService, zone) {
        ...
        this._reqSubject = Observable_1.Observable.fromEvent(socket, "request").map(http_1.toReq);
        this._resSubject = Observable_1.Observable.fromEvent(socket, "response").map(http_1.toRes);
